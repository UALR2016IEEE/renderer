...
class Grid(object):
    ...
    def init_grid(self):
        ...
        if vColorsCity:
            self.data[self.data == 60] = self.objects['FLOOR']
            self.data[self.data == 70] = self.objects['FLOOR']
        else:
            self.data[self.data == 60] = self.objects['FLOOR']
            self.data[self.data == 70] = self.objects['FLOOR']
        ...
        if vColorsOffroad:
            self.data[self.data == 80] = self.objects['FLOOR']
            self.data[self.data == 90] = self.objects['FLOOR']
        else:
            self.data[self.data == 80] = self.objects['FLOOR']
            self.data[self.data == 90] = self.objects['FLOOR']
